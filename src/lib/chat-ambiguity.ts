...
/** Count consecutive recent user messages expressing uncertainty (incl. current). */
...
/** Clarify chips must be concrete program topics — never uncertainty/meta answers. */
...
/**
 * Drops invalid LLM-generated options (e.g. "ik weet het niet") and fills from
 * retrieval/profile/program fallbacks until at least two valid chips exist.
 */
...
/** Vague reply right after a clarify prompt — e.g. user tapped "ik weet het niet". */
